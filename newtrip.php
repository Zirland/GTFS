...
switch ($action) {
	...
	case "zastavky" :
		...
		if ($departure == '') {
			...
			$departure = substr ($departure,0,2).":".substr ($departure,-2).":00";
		}
...
echo "<form method=\"post\" action=\"newtrip.php\" name=\"hlava\"><input name=\"action\" value=\"hlava\" type=\"hidden\">";
...
echo "<form method=\"post\" action=\"newtrip.php\" name=\"zastavky\"><input name=\"action\" value=\"zastavky\" type=\"hidden\"><input name=\"trip_id\" value=\"$trip\" type=\"hidden\">";
$posledni_seq = 0;
...
if ($result108 = mysqli_query ($link, $query108)) {
	...
	echo "<tr><td><input name=\"last_id\" value=\"$posledni_id\" type=\"hidden\"><input name=\"last_prubeh\" value=\"$lastprubeh\" type=\"hidden\"><input name=\"last_poradi\" value=\"$posledni_seq\" type=\"hidden\">";
...
echo "<form method=\"post\" action=\"newtrip.php\" name=\"grafikon\"><input name=\"action\" value=\"grafikon\" type=\"hidden\"><input name=\"trip_id\" value=\"$trip_id\" type=\"hidden\">";

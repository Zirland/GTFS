...
switch ($action) {
	...
	$ready0 = "UPDATE trip SET route_id='$linka', matice='$matice', trip_headsign='$trip_headsign', direction_id='$smer'. block_id='$blok', wheelchair_accessible='$invalida', bikes_allowed='$cyklo', active='$aktif' WHERE (trip_id = '$route');";
...
echo "<select name=\"dir$x\"><option value=\"0\"";

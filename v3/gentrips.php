				...
				if ($result19 = mysqli_query($link, $query19)) {
					while ($row19 = mysqli_fetch_row($result19)) {
						...
						switch($druh) {
							...
							case "SC" :
							case "Ex" :
							case "Rx" : $route_color = "008000"; $route_text_color = "FFFFFF"; break;

							case "R" :
							case "EN" : $route_color = "B51741"; $route_text_color = "FFFFFF"; break;

							case "RJ" : $route_color = "ECAE01"; $route_text_color = "000000"; break;

							case "AEx" : $route_color = "008983"; $route_text_color = "FFFFFF"; break;

							case "LE" : $route_color = "000000"; $route_text_color = "FFFFFF"; break;

							case "Sp" :
							case "Os" :
							case "TLX" :
							case "TL" : $route_color = "0094DE"; $route_text_color = "FFFFFF"; break;
						}
					}
				}
				
				if ($agency_id == '153') {$route_color = "008983"; $route_text_color = "FFFFFF";}
				$query26 = "INSERT INTO route (route_id, agency_id, route_short_name, route_long_name, route_type, route_color, route_text_color,active) VALUES ('$route_id' ,'$agency_id','$route_short_name','$route_long_name','$route_type','$route_color','$route_text_color','1');";
//				echo "$query26<BR/>";
